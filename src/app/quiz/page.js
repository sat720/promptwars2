...
export default function QuizPage() {
    ...
    return (
      <div className="page-wrapper flex-center" style={{ minHeight: '100vh' }}>
        <div className="card" style={{ maxWidth: 520, width: '100%', textAlign: 'center', padding: 40 }}>
          ...
          <h1 style={{ fontSize: '1.8rem', fontWeight: 800, marginBottom: 12 }}><TranslatedText text="Election Knowledge Quiz" /></h1>
          ...
          <button className="btn btn-primary btn-lg" onClick={() => setStarted(true)} style={{ width: '100%' }}>
    ...
    return (
      <div className="page-wrapper flex-center" style={{ minHeight: '100vh' }}>
        <div className="card animate-bounce-in" style={{ maxWidth: 520, width: '100%', textAlign: 'center', padding: 40 }}>
          ...
          <h1 style={{ fontSize: '1.8rem', fontWeight: 800, marginBottom: 8 }}><TranslatedText text="Quiz Completed!" /></h1>
  ...
  return (
    <div className="page-wrapper flex-center" style={{ minHeight: 'calc(100vh - 80px)' }}>
      <div className="container" style={{ maxWidth: 600 }}>
        <div style={{ marginBottom: 24 }}>
          <div className="flex-between" style={{ marginBottom: 12 }}>
            ...
            <span style={{ fontWeight: 700, color: 'var(--primary-light)' }}><TranslatedText text="Score" />: {score}</span>
          </div>
        ...
        <div className="card">
          <div className="flex-between" style={{ marginBottom: 24, alignItems: 'flex-start' }}>
            <h2 style={{ fontSize: '1.2rem', fontWeight: 700, lineHeight: 1.5 }}>{q.question}</h2>
            <button onClick={() => speakQuestion(q.question)} className="btn btn-ghost btn-icon" style={{ flexShrink: 0, marginLeft: 16 }}>
              <Volume2 size={20} />
            </button>
          </div>
          ...
          {answered && (
            <div className="animate-fade" style={{ padding: 16, background: 'rgba(99,102,241,0.05)', borderRadius: 12, border: '1px solid var(--border2)', marginBottom: 24 }}>
          ...
          <button disabled={!answered} onClick={handleNext} className="btn btn-primary" style={{ width: '100%' }}>
